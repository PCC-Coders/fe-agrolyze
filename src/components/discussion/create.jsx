...
export default function CreateDiscussion() {
    ...
    return (
        <div className="bg-agro-light-gray p-4 rounded-lg shadow-md w-full max-w-3xl mx-auto">
            ...
            <div className="flex items-center justify-end mt-4 gap-4">
                ...
                <div className="relative">
                    ...
                    />
                    <FiImage size={28} className="text-gray-600 cursor-pointer sm:text-2xl md:text-3xl" />
                </div>
