...
export default function Login() {
    ...
    return (
        <div className="relative min-h-screen bg-cover bg-center" style={{ backgroundImage: `url('/images/Register.svg')` }}>
            {/* Overlay */}
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen">
                <div className="bg-white bg-opacity-30 backdrop-blur-md rounded-xl shadow-lg p-8 w-[350px]">
                    <h2 className="text-2xl sm:text-4xl font-bold text-agro-dark-green mb-4">Masuk</h2>
                    <form onSubmit={handleSubmit}>
                        ...
                        {popupMessage && <p className="text-green-500 text-sm">{popupMessage}</p>}
                        ...
                        <div className="text-base text-center">
                            <p>
                                Belum punya akun?{' '}
                                <Link href="/daftar" className="text-agro-dark-green text-semibold">
                                    Daftar
                                </Link>
                            </p>
                        </div>
