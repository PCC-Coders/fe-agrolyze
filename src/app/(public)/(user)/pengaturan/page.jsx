            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-1/4">
                    <ul className="space-y-3">
                        {/* Menu Profil */}
                        <li
                            className={`flex items-center p-2 cursor-pointer text-sm md:text-base ${activeTab === "profil"
                        ...
                        {/* Menu Ganti Password */}
                        <li
                            className={`flex items-center p-2 cursor-pointer text-sm md:text-base ${activeTab === "password"
                                ? "border-l-4 border-white text-white"
                                : "border-l-4 border-transparent text-white"
                                }`}
